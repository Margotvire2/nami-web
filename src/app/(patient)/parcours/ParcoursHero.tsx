...
export function ParcoursHero({ current, total }: ParcoursHeroProps) {
  ...
  return (
    <header style={{ marginBottom: 24 }}>
      ...
      >
        Suivez les phases de votre parcours et l&apos;avancement de chaque
        étape avec votre équipe soignante.
      </p>
