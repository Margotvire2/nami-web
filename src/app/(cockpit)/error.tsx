 ...
 *
 * Error boundary du groupe (cockpit). Intercepte les erreurs des pages
 * soignant (/aujourd-hui, /patients, /agenda, /messages, etc.) AVANT que
 * le root error.tsx ne soit appelé — préserve le shell cockpit.
 *
 * - Sentry tag `boundary=cockpit`
...
export default function CockpitError({
  ...
  return (
    <div className="h-full flex items-center justify-center px-4" style={{ backgroundColor: "#FAFAF8" }}>
      <div
      ...
      >
        ...
        <p className="text-sm mb-4 leading-relaxed" style={{ color: "#6B7280" }}>
          Vous pouvez réessayer ou revenir à votre accueil. Notre équipe a été notifiée.
          {error.digest && (
