...
const STATUS_META: Record<AppointmentStatus, { label: string; className: string }> = {
  ...
  PATIENT_ARRIVED: { label: "Patient arrivé", className: "bg-emerald-50 text-emerald-700 border-emerald-200" },
  COMPLETED:       { label: "Réalisé",        className: "bg-gray-50 text-gray-500 border-gray-200" },
  ...
  ABSENCE:         { label: "Indisponible",   className: "bg-muted text-muted-foreground border-border" },
}
