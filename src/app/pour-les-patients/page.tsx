...
export const metadata: Metadata = {
  title: "Nami pour les patients — Coordonnez vos soins",
  description:
    "Retrouvez votre équipe de soins réunie, suivez votre parcours et restez coordonné avec vos soignants. L'espace patient Nami centralise votre santé.",
  keywords: [
    "espace patient",
    "coordination soins",
    "rendez-vous médical",
  ...
  alternates: { canonical: "/pour-les-patients" },
  openGraph: {
      ...
      <main className="min-h-screen" style={{ background: "#FAFAF8" }}>
        ...
        >
          <div style={{ maxWidth: 720, margin: "0 auto" }}>
            ...
            >
              Retrouvez votre équipe de soins réunie, prenez vos rendez-vous, suivez votre parcours et
              communiquez avec vos soignants.
            </p>
