...
export const metadata: Metadata = {
  title: "Inscrire ma structure — Nami",
  description:
    "CPTS, MSP, réseau, fédération, hôpital ou clinique : demandez votre espace Nami de coordination pluridisciplinaire en quelques minutes.",
  alternates: { canonical: "/pour-structures" },
  openGraph: {
    title: "Inscrire ma structure de santé sur Nami",
    description:
      "Demandez votre espace de coordination Nami. Validation manuelle par l'équipe en 24-48h.",
    url: "/pour-structures",
  },
};
...
export default function PourStructuresLanding() {
  return (
    <>
      <PublicNavbar />
      <main
      ...
      >
        ...
        >
          <div style={{ ...sectionWrap, textAlign: "center" }}>
            ...
            >
              CPTS, MSP, réseaux, fédérations, hôpitaux : demandez votre espace
              Nami de coordination pluridisciplinaire. Validation manuelle par
