      ...
      <section style={{ background: "#5B4EC4", padding: "64px 24px", textAlign: "center" }}>
        <Fade>
          <p style={{ fontSize: 24, fontWeight: 700, color: "#fff", maxWidth: 680, margin: "0 auto 16px" }}>
            "Pour la première fois, mon MG a vu le protocole MTX avant de prescrire un AINS. On a évité une interaction médicamenteuse sérieuse."
          </p>
          <p style={{ color: "#C7D2FE" }}>— Dr Laurent M., rhumatologue, Bordeaux</p>
        </Fade>
      </section>
