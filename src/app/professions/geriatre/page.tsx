      ...
      <section style={{ background: "#5B4EC4", padding: "64px 24px", textAlign: "center" }}>
        <Fade>
          <p style={{ fontSize: 24, fontWeight: 700, color: "#fff", maxWidth: 680, margin: "0 auto 16px" }}>
            "La fille du patient m'a appelée pour me remercier. Pour la première fois, elle savait exactement ce qui se passait sans avoir à appeler 4 personnes différentes."
          </p>
          <p style={{ color: "#C7D2FE" }}>— Dr Françoise B., gériatre, CHU de Toulouse</p>
        </Fade>
      </section>
