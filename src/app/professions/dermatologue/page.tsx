      ...
      <section style={{ background: "#5B4EC4", padding: "64px 24px", textAlign: "center" }}>
        <Fade>
          <p style={{ fontSize: 24, fontWeight: 700, color: "#fff", maxWidth: 680, margin: "0 auto 16px" }}>
            "L'allergologue a pu voir mon protocole dupilumab avant de faire les prick-tests. On a évité de tout recommencer depuis zéro."
          </p>
          <p style={{ color: "#C7D2FE" }}>— Dr Marie L., dermatologue, Paris 15e</p>
        </Fade>
      </section>
