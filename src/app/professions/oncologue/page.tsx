      ...
      <section style={{ background: "#5B4EC4", padding: "64px 24px", textAlign: "center" }}>
        <Fade>
          <p style={{ fontSize: 24, fontWeight: 700, color: "#fff", maxWidth: 680, margin: "0 auto 16px" }}>
            "Le psycho-oncologue avait lu le plan de traitement avant la séance. Pour la première fois, son accompagnement était vraiment adapté à où en était le patient."
          </p>
          <p style={{ color: "#C7D2FE" }}>— Dr Philippe R., oncologue médical, Institut Gustave Roussy</p>
        </Fade>
      </section>
