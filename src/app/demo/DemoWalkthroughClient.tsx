  ...
  return (
    <div style={{ display: "flex", minHeight: 340 }}>
      ...
      <div style={{ flex: 1, padding: 20 }}>
        <div style={{ fontSize: 15, fontWeight: 700, marginBottom: 4 }}>Bonjour, Dr. Gervaix 👋</div>
    ...
    <div style={{ display: "flex", minHeight: 340 }}>
      ...
      <div style={{ flex: 1, padding: 20 }}>
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 16, flexWrap: "wrap" }}>
          {[
            { ini: "AG", name: "Dr Gervaix", role: "Pédiatre", bg: C.nami },
        ...
        <div style={{ borderTop: `1px solid ${C.bl}`, paddingTop: 12 }}>
          {[
            ...
            { ini: "AG", bg: C.nami, name: "Dr Gervaix", text: "Merci pour les retours. Je prescris un contrôle bio avant la réévaluation pluridisciplinaire du 15 mai.", time: "14:30", role: "Pédiatre" },
          ].map((m, i) => (
